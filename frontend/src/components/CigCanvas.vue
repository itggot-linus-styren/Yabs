...
export default class CigCanvas extends Vue {
    ...
    public drawImages() {
        ...
        setTimeout(() => {
            ...
            this.context.arc(this.width / 4 + this.width / 4, this.height / 4 + this.width / 4,
                             this.width / 4, 0, Math.PI * 2, true);
            this.context.closePath();
            this.context.clip();

            this.context.drawImage(profileImage, this.width / 4, this.height / 4, this.width / 2, this.width / 1.5);

            this.context.beginPath();
            this.context.arc(this.width / 4, this.height / 4, this.width / 2, 0, Math.PI * 2, true);
            this.context.clip();
            this.context.closePath();
