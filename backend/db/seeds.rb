...
Book.create(barcode: "5002", condition: "Broken", title: title_alice).dump_fixture
Book.create(barcode: "5003", condition: "OK", title: title_alice).dump_fixture
Book.create(barcode: "5004", condition: "OK", title: title_lotr).dump_fixture
Book.create(barcode: "5005", condition: "Broken", title: title_lotr).dump_fixture
Book.create(barcode: "5006", condition: "OK", title: title_cc).dump_fixture
Book.create(barcode: "5007", condition: "OK", title: title_tomtens_jul).dump_fixture
Book.create(barcode: "5008", condition: "OK", title: title_tomtens_jul).dump_fixture
